...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
	  return new _calculator2.default();
	});
	...
	var Calculator = function () {
	  ...
	  (0, _createClass3.default)(Calculator, [{
	    ...
	    value: function onClickAction() {
	      ...
	      var sum = this.getSum((0, _utils.mapObject)({ a: numberA, b: numberB }, this.parse));
	      this.display(sum);
	    }
	  }]);
	  return Calculator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapObject = exports.mapObject = function mapObject(obj, func) {
	  ...
	  return keys.reduce(function (result, key) {
	    return (0, _extends3.default)({}, result, { key: func(obj[key]) });
	  }, {});
	};
...
//# sourceMappingURL=0.1d030dc209f77a25b2a8.hot-update.js.map